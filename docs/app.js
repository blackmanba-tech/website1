document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 加载充值档位
  try {
    const res = await fetch('https://fooqjqatdmwrfuarrdmc.functions.supabase.co/website1/api/channels');
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      for (let i = 0; i < quantity; i++) {
        const res = await fetch('https://fooqjqatdmwrfuarrdmc.functions.supabase.co/website1/api/generate-card', {
          method: 'POST',
